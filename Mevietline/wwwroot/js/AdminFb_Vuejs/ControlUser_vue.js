control_user = new Vue({
    ...
    mounted() {
        axios.get("/AdminFb/GetAllUserInfo")
            .then((response) => {
                this.dataUser = response.data;
                return Promise.resolve();
            })
            .then(() => {
                $("#dataUser_table").DataTable({
                    'columnDefs': [{
                        'targets': [-1],
                        'orderable': false,
                    }],
    ...
    methods: {
        getIdBangUser(id) {
            ...
            axios.get(`/AdminFb/GetAllUserInfoID/${id}`)
                .then((response) => {
                    ...
                    this.tienDangCo = response.data.tienDangCo;
                    this.soDiem = response.data.soDiem;
        ...
        suaBangUser() {
            ...
            if (curentThis.idUser != null) {
                formData.append('TienDangCo', this.tienDangCo);
                formData.append('SoDiem', this.soDiem);
                formData.append('Id', this.idUser);
                

            }
            axios.post('/AdminFb/GetAllUserInfoID', formData, {
                headers: {
        ...
        DoiMatKhau() {
            ...
            axios.post('/AdminFb/ChangePass', formData, {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                }
            }).then(response => {
            ...
            if (this.idUser != null) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post('/AdminFb/XoaUserMain', formData, {
                            headers: {
                                'Content-Type': 'application/x-www-form-urlencoded'
                            }
                        }).then(response => {
