Vue_Profile = new Vue({
    ...
    mounted() {
        axios.get("/Home/GetDataNap")
            .then((response) => {
                this.DataUser = response.data;
                return Promise.resolve();
            })
            .then(() => {
                $("#Lenh_nap_table").DataTable({
                    'columnDefs': [{
                        'targets': [-1],
                        'orderable': false,
                    }],
        ...
        axios.get("/Home/GetDataRut")
            .then((response) => {
                this.DataUserRut = response.data;
                return Promise.resolve();
            })
            .then(() => {
                $("#Lenh_rut_table").DataTable({
                    'columnDefs': [{
                        'targets': [-1],
                        'orderable': false,
                    }],
        ...
        axios.get("/Home/GetDataMua")
            .then((response) => {
                this.DataUserMuaLenh = response.data;
                return Promise.resolve();
            })
            .then(() => {
                $("#Lenh_Mua_Sp_table").DataTable({
                    'columnDefs': [{
                        'targets': [-1],
                        'orderable': false,
                    }],
        ...
        axios.get("/Home/GetDataBan")
            .then((response) => {
                this.DataUserBanLenh = response.data;
                return Promise.resolve();
            })
            .then(() => {
                $("#Lenh_Ban_Sp_table").DataTable({
                    'columnDefs': [{
                        'targets': [-1],
                        'orderable': false,
                    }],
        ...
        getDataUserId() {
            axios.get("/Home/GetDataProfileMainTien")
                .then((response) => {
                    ...
                    this.soDiem = response.data[0].soDiem;
